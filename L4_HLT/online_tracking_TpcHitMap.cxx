/***********************************************************************
 *
 * $Id: online_tracking_TpcHitMap.cxx,v 1.4 2016/04/17 01:37:39 kehw Exp $
 *
...
void online_tracking_TpcHitMap::readHLTparameters(const char* HLTparameters)
{
    ...
    if(!ifs.fail())
        while(!ifs.eof()) {
            ...
            if (parameterName == "SCEWRatio")        ifs >> SCEWRatio;
...
void online_tracking_TpcHitMap::setSpaceChargeFromScalerCount(double scalerCount)
{
    ...
    if (sectorID >= 12 && sectorID <= 23) { // east TPC
        spaceCharge *= SCEWRatio;
    }
}
...
#ifdef USE_REALTIME_DRIFT_VELOCITY
...
#endif  // USE_REALTIME_DRIFT_VELOCITY
}
